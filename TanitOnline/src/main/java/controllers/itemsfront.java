...
public class itemsfront {
    ...
    private ShowEtablissement showEtablissementController;

    public void setShowEtablissementController(ShowEtablissement showEtablissementController) {
        this.showEtablissementController = showEtablissementController;
    }
