...
public class servicePaiement {
    ...
    public void updatePaiement(int reservationID, float newMontant) {
    ...
    public void updateHeure(int reservationId, Timestamp timestamp) {
        ...
        try (PreparedStatement statement = cnx.prepareStatement(query)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    String heure_P = resultSet.getString("heure_P");
